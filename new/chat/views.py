...
def get_chat(request, chat_id):
    ...
    response = {
        'id': conversation.id,
        'other_user': conversation.user1.username if current_user == conversation.user2 else conversation.user2.username,
        'other_user_id': conversation.user1.id if current_user == conversation.user2 else conversation.user2.id,
        'messages': [{'message': message.message, 'issuer': message.issuer.username} for message in messages]
    }
